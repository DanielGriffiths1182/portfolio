    ...
    const skills = [
      {
        ...
        stack: 'Back End',
        url: 'url("../../assets/top-skill/javaScript.png")'
      },
      {
        id: 2,
        skillName: 'Ruby',
        ...
        stack: 'Back End',
        url: 'url("../../assets/top-skill/ruby.png")'
      },
      {
        id: 3,
      ...
      },
      {
        ...
        stack: 'Back End',
        url: 'url("../../assets/top-skill/java.png")'
      },
      {
        id: 5,
        skillName: 'Python',
        ...
        stack: 'Back End',
        url: 'url("../../assets/top-skill/rails.png")'
      },
      {
        id: 6,
        skillName: 'PHP',
    ...
    const repos = [
      {
        ...
        url: 'url("../../assets/top-skill/angular.png")'
      },{
        id: 2,
      ...
      },
      {
        ...
        mainSkill: 'PHP',
        url: 'url("../../assets/top-skill/php.png")'
      },{
        id: 4,
